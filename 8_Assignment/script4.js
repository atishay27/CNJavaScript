...
const newPostCaption = document.querySelector("#postInput");
const newPostImage = document.querySelector("#imageInput");
newPostForm.addEventListener("submit", (e) => {
  e.preventDefault();
  const newObj = {
    id: postsData.length,
    author: "You",
    content: newPostCaption.value,
    likes: 0,
    comments: [],
    image: URL.createObjectURL(newPostImage.files[0]),
  };
